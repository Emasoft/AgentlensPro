...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: standalone/server.ts computeAnalyticsData replaces Math.min/max(...times) with a bounded for-loop (comment cites 9da7609/TRDD-2YP3DB9Y), no remaining spread-into-call in the summarizeSpans path.
