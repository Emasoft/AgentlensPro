...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/ndjsonBuckets.ts + src/logEventSink.ts + src/retentionConfig.ts:40 (AGENTLENS_LOG_EVENTS_RETENTION_DAYS) exist.
