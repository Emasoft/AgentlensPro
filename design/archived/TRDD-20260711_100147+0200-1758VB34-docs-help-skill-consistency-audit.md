...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: ARCHITECTURE.md:1050 documents the TtlRegime model (CACHE_TTL_MS gone); .gitignore lines 13-14 own media/dashboard.css.
