...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: media/src/tabs/Traces.tsx:1091 renders the `cache-break-diff-popup` dialog and src/shared/cacheBreak.ts:107 exports `diffTurnSources`.
