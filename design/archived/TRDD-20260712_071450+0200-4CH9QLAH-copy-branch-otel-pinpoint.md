...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: standalone/server.ts:3919 POST /api/branch-dump handler present, src/shared/branchSerialize.ts and media/src/CopyBranchButton.tsx exist.
