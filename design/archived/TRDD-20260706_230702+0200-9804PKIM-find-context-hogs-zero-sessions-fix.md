...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/contextComposition.ts:141 exports listSessionFileIds; src/mcpServer.ts:2459 defines fileBackedPool and all three cross-session handlers (mcpServer.ts:2504,2597,2791) use it.
