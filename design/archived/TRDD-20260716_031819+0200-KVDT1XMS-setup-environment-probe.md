...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/cli/setup.ts:424 `stepEnvironment` in STEPS pipeline.
