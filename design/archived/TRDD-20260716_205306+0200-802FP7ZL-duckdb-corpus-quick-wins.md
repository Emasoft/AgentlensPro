...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/store/db.ts:163 sets enable_object_cache, src/test/storeValidate.test.ts:136/152 pins the run-twice contract.
