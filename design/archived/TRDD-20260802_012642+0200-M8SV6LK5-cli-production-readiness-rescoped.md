...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity
  re-verified: src/cli/serverControl.ts:178 exports `startupVerdict`, src/test/ctxmapScanHonesty.test.ts
  and src/test/cliHotPathLatency.test.ts exist on disk.
