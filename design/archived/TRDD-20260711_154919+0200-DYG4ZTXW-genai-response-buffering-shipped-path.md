...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/segmentedSpanStore.ts:271 exports injectSpanAttribute; src/test/standaloneGenAiInject.test.ts + src/test/segmentedSpanStore.test.ts exist.
