...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/accountBurners.ts + src/mcpServer.ts:463,3418 implement `get_account_burners`.
