...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: package.json bin.agentlenspro -> ./standalone/cli.js (package.json:36-38); CHANGELOG.md "## [2.0.0] — 2026-07-11" confirms the publish.
