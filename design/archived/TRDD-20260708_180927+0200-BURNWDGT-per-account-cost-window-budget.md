...
## Approval log
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified:
  the STATE block's "NEXT ACTIONS (NOT yet built)" is stale — later commits (b8abda2..dfb97c7) shipped
  them: src/burnMonitor.ts accountUuid-keyed per-account grouping (:40,:276), window5hCostUsd/
  window7dCostUsd cost-based caps (:114-115), observed per-account auto-calibration (:132-135), and
  accountLabel account/plan surfacing (:653).
