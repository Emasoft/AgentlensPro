...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: src/extension.ts and src/dashboardPanel.ts are absent; src/vscodeCompat.ts exists; grep for vscode imports over src/standalone/media returns none.
