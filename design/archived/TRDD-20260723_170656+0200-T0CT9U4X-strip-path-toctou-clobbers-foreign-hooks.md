...
- 2026-08-18T12:45:00+0200 — ARCHIVED by USER batch directive ("complete all TRDD"); validity re-verified: scripts/safe_config_edit.py:172 implements `remove_by_substring` with `prune_empty`, and src/cli/hookInstall.ts:201 uses it on the strip path.
