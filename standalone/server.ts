...
import { computeSidebarPayload, computeSidebarData, computeAnalyticsData } from '../src/updatePayload'
...
// computeSidebarPayload / computeSidebarData / computeAnalyticsData live in src/updatePayload.ts
// (moved verbatim for the Rust port's TS-oracle harness — TRDD-DMWOBWFH P4f).
